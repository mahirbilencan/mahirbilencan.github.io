...
## Industry-facing direction

A growing part of this work connects mathematical structure with computational and communication problems, including quantum technologies, error-correcting codes, and secure information processing.

For complete output and references, see [publications](/publications/) and my [CV](/assets/pdf/CV.pdf).
